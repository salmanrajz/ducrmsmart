...
use App\Models\missionduthird;
use Illuminate\Console\Command;

class MissionDu3 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'MissionDu3';
     ...
     * @var string
     */
    protected $description = 'Mission DU 3 for 97152';
    ...
    public function handle()
    {
        ...
        //     echo $i . '<br>';
        //     if($i == 0){
        //         echo $url = 'https://salmanrajzzdiag.blob.core.windows.net/callmax/mission_third/bgt-1.csv';
        //         missionduthird::create([
        //             'filename' => $url,
        //         ]);
        //     }
        //     // else if($i == 1){
        ...
        //     // }
        //     else{
        //         $url = 'https://salmanrajzzdiag.blob.core.windows.net/callmax/mission_third/bgt-' . $i . '.csv';
        //         missionduthird::create([
        //             'filename' => $url,
        //         ]);
        //     }
        ...
        if ($m) {
            ...
            if ($httpcode == 200) {
                ...
                $m = missionduthird::where('filename', $link)->first();
                $m->status = 1;
                $m->save();
            } else {
                $details = [
