...
class ActivationSheet implements FromCollection,WithHeadings
{
    ...
    */
    public function collection()
    {
        //
        //
        return $data = lead_sale::select('lead_sales.customer_name','lead_sales.customer_number','lead_sales.lead_type','users.name as agent_name','users.agent_code','plans.name as plan_name','lead_sales.updated_at','lead_sales.lead_no')
        // return $data = ActivationForm::select('activation_forms.customer_name', 'activation_forms.lead_no', 'activation_forms.customer_number', 'users.name as agent_name', 'users.agent_code','activation_forms.gender', 'activation_forms.nationality', 'activation_forms.lead_type', 'plans.plan_name',  'activation_forms.lead_date', 'activation_forms.omid', 'activation_forms.status', 'activation_forms.language','activation_forms.updated_at')
        ...
        //     // ->whereYear('activation_forms.created_at', Carbon::now()->subYear)
        //     ->get();
    }
