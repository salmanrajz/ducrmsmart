...
use App\Models\mission_four_du;
use Illuminate\Console\Command;

class MissionDu4 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'MissionDu4';
     ...
     * @var string
     */
    protected $description = 'MissionDU4';
    ...
    public function handle()
    {
        ...
        //     echo $i . '<br>';
        //     if($i == 0){
        //         echo $url = 'https://salmanrajzzdiag.blob.core.windows.net/callmax/mission_four/bgt-1.csv';
        //         mission_four_du::create([
        //             'filename' => $url,
        //         ]);
        //     }
        //     // else if($i == 1){
        ...
        //     // }
        //     else{
        //         $url = 'https://salmanrajzzdiag.blob.core.windows.net/callmax/mission_four/bgt-' . $i . '.csv';
        //         mission_four_du::create([
        //             'filename' => $url,
        //         ]);
        //     }
        ...
        if ($m) {
            ...
            if ($httpcode == 200) {
                ...
                $m = mission_four_du::where('filename', $link)->first();
                $m->status = 1;
                $m->save();
            } else {
                $details = [
