    ...
    */
    ...
    public function collection(Collection $collection)
    {
        ...
        foreach ($collection as $row) {
            ...
            if(is_numeric(mj::clean($row['4'])) && strlen(mj::clean($row['4'])) > 7 || mj::clean($row['4']) === 'number'){
                // dd(mj::clean($row[4]));
                if(isset($row[6])){
            ...
            else if(is_numeric($row['7']) && strlen($row['7']) > 7 || $row['7'] === 'number'){
                // dd($row);
            ...
            //     dd("ok");
            // }
            else if(is_numeric($row['10']) && strlen($row['10']) > 7 || $row['10'] === 'number'){
                dd($row);
                if ($row['4'] == 'TRUE' || $row['4'] == true) {
                    $prepaid = 'prepaid';
                } else {
